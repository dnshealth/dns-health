...
class Test(TestCase):
    def test_run(self):
        ...
        res = run("google.com", ["ns1.google.com", "ns2.google.com", "ns3.google.com", "ns4.google.com"])
        assert res["result"]
    ...
    def test_run_5(self):
        ...
        res = run("kth.se", ["a.a.a"])
        assert not res["result"]
        
    def test_run_6(self):
        # This should pass as all nameserver will have the same NS records
